...
export default async function SettingsPage({ searchParams }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {tab === "you" && (
        <div className="flex flex-col gap-10">
          <Section title="Your photo" description="Shown next to your name for the rest of the team. If you sign in with Google, your Google photo is used until you upload one.">
            <Card>
              <div className="px-5 py-6">
                <PhotoForm
                  userId={user.id}
