    ...
    <main className="min-h-screen bg-ink-50 px-5 py-12">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-8 text-2xl font-semibold tracking-tight text-ink-900">
          {billingCo ? "Add your first client" : "Set up your practice"}
        </h1>
        <p className="mt-1 max-w-xl text-sm text-ink-500">
          {billingCo
            ? "Each client is a practice you credential for. Start with one — you can add the rest from the dashboard. "
            : ""}
