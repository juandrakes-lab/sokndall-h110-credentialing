...
const ITEMS = [
  ...
  { href: "/follow-ups", label: "Follow-ups", icon: "M12 8v4l3 2M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
  ...
  { href: "/enrollments", label: "Enrollments", icon: "M3 3h18v18H3zM3 9h18M3 15h18M9 3v18M15 3v18" },
  { href: "/documents", label: "Documents", icon: "M14 3H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2V9zM14 3v6h6M8 13h8M8 17h5" },
  { href: "/import-export", label: "Import / Export", icon: "M12 3v12M7 10l5 5 5-5M4 21h16" },
...
// Billing Co only (alcance §5): the panel across all clients.
const CLIENTS = { href: "/clients", label: "Clients", icon: "M3 21V7l9-4 9 4v14M9 21v-6h6v6M8 10h.01M12 10h.01M16 10h.01" };

export default function AppNav({ showClients = false }) {
  const pathname = usePathname();
  const items = showClients ? [ITEMS[0], CLIENTS, ...ITEMS.slice(1)] : ITEMS;
