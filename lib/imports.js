...
export const PROVIDER_IMPORT_FIELDS = [
  { key: "first_name", label: "First name", required: true, aliases: ["first", "given name", "firstname"] },
  { key: "last_name", label: "Last name", required: true, aliases: ["last", "surname", "family name", "lastname"] },
