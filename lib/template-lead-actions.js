...
// The sheet is shared "anyone with the link can view". Copying it needs a
// Google account; the .xlsx export does not, for practices on Excel.
const SHEET = "https://docs.google.com/spreadsheets/d/1oB5qRAYgkcRr21yqr2NMkKMsVYoneZwwFr3OLs6ejO8";
const TEMPLATE_URL = `${SHEET}/copy`;
const EXCEL_URL = `${SHEET}/export?format=xlsx`;
  ...
  try {
    await sendEmail({
      ...
      text: [
        ...
        "",
        "It opens in Google Sheets and asks you to make a copy, which is yours to edit.",
        "",
        `On Excel instead? Download the Excel file: ${EXCEL_URL}`,
        "",
        "Sokndall",
        "",
...
<p>It opens in Google Sheets and asks you to make a copy, which is yours to edit.</p>
<p>On Excel instead? <a href="${EXCEL_URL}" style="color:#0e2a2e">Download the Excel file</a>.</p>
<p>Sokndall</p>
