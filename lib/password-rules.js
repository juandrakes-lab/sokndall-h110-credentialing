...
// TERMS_VERSION is stamped on each sign-up with the acceptance time. "draft"
// until the legal text is written; bump it on the day the final text goes live.
export const TERMS_VERSION = "draft";
